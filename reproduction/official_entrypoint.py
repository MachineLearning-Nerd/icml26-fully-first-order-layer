...
def main():
    ...
    selected = available[args.core_offset : args.core_offset + args.cores]
    ...
    effective_cores = len(os.sched_getaffinity(0)) if hasattr(os, "sched_getaffinity") else args.cores
    print(f"OFFICIAL_ENTRYPOINT script={args.script} effective_cores={effective_cores}", flush=True)
